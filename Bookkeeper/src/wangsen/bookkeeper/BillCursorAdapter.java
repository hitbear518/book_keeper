...
public class BillCursorAdapter extends CursorAdapter {
	...
	public void bindView(View view, Context context, Cursor cursor) {
		...
		labelAdultsCount.setText(cursor.getInt(
				cursor.getColumnIndex(Bills.COLUMN_NAME_ADULTS_COUNT))
				+ context.getString(R.string.adult));
		TextView labelChildrenCount = (TextView) view.findViewById(R.id.label_children_count);
		labelChildrenCount.setText(cursor.getInt(
				cursor.getColumnIndex(Bills.COLUMN_NAME_CHILDREN_COUNT))
		...
		labelPayment.setText(cursor.getInt(
				cursor.getColumnIndex(Bills.COLUMN_NAME_PAYMENT))
		...
		Date dateTime = new Date(cursor.getLong(
				cursor.getColumnIndex(Bills.COLUMN_NAME_TIME)));
		...
		int billPaid = cursor.getInt(
				cursor.getColumnIndex(Bills.COLUMN_NAME_BILL_PAID));
